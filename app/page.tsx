    ...
    <>
        ...
        <div className="container">
          ...
          >
            ...
            >
              ...
              <p style={{ fontSize: 14, color: "var(--soft)", lineHeight: 1.7, marginBottom: 28 }}>
                Alta concentração de hotéis, condomínios verticais e imóveis de luxo. Demanda constante por restauração técnica.
              </p>
            ...
            >
              ...
              />
              <div className="label-mono" style={{ marginBottom: 12, color: "var(--gold)" }}>
                PR · Sem concorrência técnica
              </div>
              <h3 className="h2" style={{ color: "var(--ice)", marginBottom: 16, fontSize: 36 }}>
                Apucarana
              </h3>
              <p style={{ fontSize: 14, color: "var(--soft)", lineHeight: 1.7, marginBottom: 28 }}>
                Mercado em crescimento sem concorrência especializada. A FA é pioneira em restauração técnica na região.
              </p>
      ...
      >
        <div className="container" style={{ position: "relative", zIndex: 2 }}>
          <p className="eyebrow" style={{ marginBottom: 16 }}>Solicite agora</p>
          <h2 className="h1" style={{ color: "var(--ice)", marginBottom: 16 }}>
            MANDA UMA<br />
            <span style={{ color: "var(--blue-l)" }}>MENSAGEM.</span>
          </h2>
          <p
            style={{
              fontSize: 17,
          ...
          <a href={waLink} target="_blank" rel="noopener" className="btn-primary" style={{ fontSize: 17, padding: "18px 40px" }}>
